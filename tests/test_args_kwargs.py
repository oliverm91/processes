...
def test_add_extra_args():
    ...
    t2 = Task(
        "task_2",
        os.path.join(curdir, "logfile_12.log"),
        div,
        args=(10,),
...
def test_add_extra_args_kwargs():
    ...
    curdir = os.path.dirname(__file__)
    tasks = []
    t0 = Task("task_0", os.path.join(curdir, "logfile_0.log"), random_routine_to_do_first)
    tasks.append(t0)
    t1 = Task("task_1", os.path.join(curdir, "logfile_12.log"), get_b)
    tasks.append(t1)
    t2 = Task(
        "task_2",
        os.path.join(curdir, "logfile_12.log"),
    ...
    t3 = Task(
        "task_3",
        os.path.join(curdir, "logfile_3.log"),
        div,
        args=(10,),
        dependencies=[
